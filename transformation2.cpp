...
int main()
{
  ...
  glBindTexture(GL_TEXTURE_2D, texture); //Bind texture after generating
  ...
  if(data) {
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, width, height, 0, GL_RGB, GL_UNSIGNED_BYTE, data); //used to load texture
